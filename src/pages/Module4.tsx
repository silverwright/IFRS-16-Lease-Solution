...
const Module4: React.FC = () => {
  ...
  const otherSubsections = [
    ...
    // PDF (updated to include Model Calculation Logics)
        ...
        {activeSection === 'assumptions' && (
          <div className="bg-white rounded-lg shadow-sm border p-6 w-full space-y-6">
            ...
            {activeAssumption === 'identification' && (
              <div>
                <h3 className="font-medium text-slate-800 mb-2">{content.assumptions.subsections.identification.title}</h3>
                <h4 className="font-semibold text-slate-700">{content.assumptions.subsections.identification.heading}</h4>
            ...
            {activeAssumption === 'measurement' && (
              <div>
                <h3 className="font-medium text-slate-800 mb-2">{content.assumptions.subsections.measurement.title}</h3>
                <h4 className="font-semibold text-slate-700">{content.assumptions.subsections.measurement.heading}</h4>
            ...
            {activeAssumption === 'other' && (
              <div>
                <h3 className="font-medium text-slate-800 mb-4">{content.assumptions.subsections.other.title}</h3>
                ...
                {activeOther === 'lease-term' && (
                  <div>
                    <h4 className="font-semibold text-slate-700">{content.assumptions.subsections.other.subsections['lease-term'].title}</h4>
                    ...
                    {content.assumptions.subsections.other.subsections['lease-term'].considerations.map((c, i) => (
                      <div key={i} className="mb-3">
                        <h5 className="font-semibold text-slate-700">{c.title}</h5>
                ...
                {activeOther === 'future-payments' && (
                  <div>
                    <h4 className="font-semibold text-slate-700">{content.assumptions.subsections.other.subsections['future-payments'].title}</h4>
                ...
                {activeOther === 'discount-rate' && (
                  <div>
                    <h4 className="font-semibold text-slate-700">{content.assumptions.subsections.other.subsections['discount-rate'].title}</h4>
                ...
                {activeOther === 'structure' && (
                  <div>
                    <h4 className="font-semibold text-slate-700">{content.assumptions.subsections.other.subsections['structure'].title}</h4>
            ...
            {activeAssumption === 'model-logics' && (
              <div>
                <h3 className="font-medium text-slate-800 mb-4">{content.assumptions.subsections.modelLogics.title}</h3>

                {/* Right of Use Asset */}
                <h4 className="font-semibold text-slate-700">{content.assumptions.subsections.modelLogics.subsections.rou.title}</h4>
                ...
                {/* Lease Liability */}
                <h4 className="font-semibold text-slate-700 mt-4">{content.assumptions.subsections.modelLogics.subsections.liability.title}</h4>
                {content.assumptions.subsections.modelLogics.subsections.liability.paragraphs.map((p, i) => (
                  <p key={i} className="text-slate-600 mb-2">{p}</p>
                ))}

                {/* Depreciation */}
                <h4 className="font-semibold text-slate-700 mt-4">{content.assumptions.subsections.modelLogics.subsections.depreciation.title}</h4>
                ...
                {/* Interest Expense */}
                <h4 className="font-semibold text-slate-700 mt-4">{content.assumptions.subsections.modelLogics.subsections.interest.title}</h4>
